...
//    }
    ...
    public MultipartConfigElement multipartConfigElement() {
        ...
        factory.setMaxRequestSize(DataSize.ofBytes(1024*1024*20)); // 전체 요청(Request)최대 사이즈 20MB
        factory.setMaxFileSize(DataSize.ofBytes(1024*1024*20)); // 1개의 파일당 최대 사이즈 20MB
